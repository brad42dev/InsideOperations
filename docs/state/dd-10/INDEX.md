...
|------|-------|--------|----------|
| DD-10-016 | BadQualityBySource widget crashes — sources.map is not a function | pending | 0 |
| DD-10-021 | Add "Open in New Window" button to Dashboard viewer toolbar | pending | 0 |
| DD-10-017 | ProductionStatus widget crashes — sources.filter is not a function | pending | 0 |
