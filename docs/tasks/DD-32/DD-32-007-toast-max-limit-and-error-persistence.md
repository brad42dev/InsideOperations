...
Primary files:
- `frontend/src/shared/components/Toast.tsx` — `ToastItem` component at line 74 applies `duration ?? 5000` for all variants; `ToastProvider` at line 174 renders all toasts without a limit
