...
| Token | Value | Notes |
|---|---|---|
| `--io-fill-normal` | `#475569` | Slate-600. Normal (non-alarm) fill for FillGauge and pipe fills. **Components apply `opacity: 0.6` on the fill element** — visual result approximates the previous `rgba(71,85,105,0.5)`. |
