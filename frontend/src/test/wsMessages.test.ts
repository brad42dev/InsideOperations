...
describe("detectDeviceType", () => {
  ...
  it("returns phone for Android Mobile UA", () => {
    setUA(
      "Mozilla/5.0 (Linux; Android 13; Pixel 7) AppleWebKit Chrome/120 Mobile Safari/604.1",
    );
    expect(detectDeviceType()).toBe("phone");
  });
  ...
  it("returns tablet for iPad UA", () => {
    setUA(
      "Mozilla/5.0 (iPad; CPU OS 17_0 like Mac OS X) AppleWebKit Safari/604.1",
    );
  ...
  it("returns tablet for Android tablet UA (no Mobile)", () => {
    setUA(
      "Mozilla/5.0 (Linux; Android 13; SM-T870) AppleWebKit Chrome/120 Safari/604.1",
    );
    expect(detectDeviceType()).toBe("tablet");
  });
});
...
describe("handleWsUpdate — unknown message types", () => {
  ...
  it("returns null for alert_notification", () => {
    expect(
      handleWsUpdate({ type: "alert_notification", point_id: "x" }),
    ).toBeNull();
  });
});
