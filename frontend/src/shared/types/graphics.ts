 ...
 */
export type DisplayElementBinding = PointBinding &
  Partial<PortablePointBinding>;
...
export interface AnalogBarConfig {
  ...
  thresholds?: {
    hh?: number;
    hhAlarmPriority?: 1 | 2 | 3 | 4 | 5;
    h?: number;
    hAlarmPriority?: 1 | 2 | 3 | 4 | 5;
    l?: number;
    lAlarmPriority?: 1 | 2 | 3 | 4 | 5;
    ll?: number;
    llAlarmPriority?: 1 | 2 | 3 | 4 | 5;
  };
}
