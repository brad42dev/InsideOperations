...
const COMMANDS: PaletteCommand[] = [
  {
    id: "console",
    label: "Console",
    description: "Multi-pane real-time process graphics",
    path: "/console",
    keywords: ["monitor", "pane", "graphics", "realtime"],
  },
  {
    id: "process",
    label: "Process",
    description: "Large-scale process view",
    path: "/process",
    keywords: ["view", "pid", "plant", "overview"],
  },
  {
    id: "designer",
    label: "Designer",
    description: "Graphics, dashboard, and report editor",
    path: "/designer",
    keywords: ["editor", "create", "design", "build"],
  },
  {
    id: "dashboards",
    label: "Dashboards",
    description: "Widget-based real-time dashboards",
    path: "/dashboards",
    keywords: ["widgets", "tiles", "kpi"],
  },
  {
    id: "reports",
    label: "Reports",
    description: "Canned and custom report generation",
    path: "/reports",
    keywords: ["pdf", "export", "canned", "schedule"],
  },
  {
    id: "forensics",
    label: "Forensics",
    description: "Historical data correlation and investigation",
    path: "/forensics",
    keywords: ["history", "investigate", "correlation", "trend"],
  },
  {
    id: "log",
    label: "Log",
    description: "Operational logbook",
    path: "/log",
    keywords: ["logbook", "shift", "notes", "handover"],
  },
  {
    id: "rounds",
    label: "Rounds",
    ...
    path: "/rounds",
    keywords: ["inspection", "checklist", "mobile", "field"],
  },
  {
    id: "alerts",
    label: "Alerts",
    description: "Emergency notifications and mustering",
    path: "/alerts",
    keywords: ["emergency", "notify", "muster", "evacuation"],
  },
  {
    id: "shifts",
    label: "Shifts",
    description: "Shift management and badge events",
    path: "/shifts",
    keywords: ["badge", "shift", "schedule", "presence"],
  },
  {
    id: "settings-users",
    ...
    path: "/settings/users",
    keywords: ["accounts", "people", "admin"],
  },
  {
    id: "settings-roles",
  ...
  {
    id: "settings-opc",
    label: "Settings: OPC Sources",
    description: "OPC UA data source configuration",
    path: "/settings/opc-sources",
    keywords: ["opc", "datasource", "ua", "connection"],
  },
  {
    ...
    keywords: ["theme", "dark", "light", "hphmi", "color"],
  },
  {
    id: "settings-health",
    ...
    keywords: ["status", "services", "monitoring", "health"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["backup", "restore", "export", "recovery"],
  },
  {
    id: "settings-about",
    ...
    path: "/settings/about",
    keywords: ["version", "build", "info", "about"],
  },
];
...
function parseQuery(raw: string): ParsedQuery {
  ...
  if (raw.startsWith("@"))
    return { scope: "points", term: raw.slice(1).trimStart(), prefix: "@" };
  if (raw.startsWith("/"))
    return { scope: "graphics", term: raw.slice(1).trimStart(), prefix: "/" };
  if (raw.startsWith("#"))
    return { scope: "entities", term: raw.slice(1).trimStart(), prefix: "#" };
    ...
    >
      ...
      */}
      ...
      >
        ...
        {showNavCommands && (
          <Command.Group heading={hasSearchResults ? "Navigation" : undefined}>
            {COMMANDS.map((cmd) => (
              <Command.Item
                key={cmd.id}
