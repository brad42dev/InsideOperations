...
const NAV_SHORTCUTS: ShortcutEntry[] = ROUTE_REGISTRY.filter((r) => r.g_key).map((r) => ({
...
const SECTIONS: ShortcutSection[] = [
  {
    title: 'Sidebar',
    shortcuts: [
      { keys: ['Ctrl', '\\'], description: 'Toggle sidebar expanded / collapsed' },
      { keys: ['Ctrl', 'Shift', '\\'], description: 'Toggle sidebar hidden / collapsed' },
      { keys: ['Ctrl', 'Shift', 'T'], description: 'Toggle top bar visibility' },
    ],
  },
  {
    title: 'Application',
...
export default function KeyboardHelpOverlay({ open, onOpenChange }: KeyboardHelpOverlayProps) {
  return (
