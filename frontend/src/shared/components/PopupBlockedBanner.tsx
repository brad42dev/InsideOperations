...
export default function PopupBlockedBanner({ state }: PopupBlockedBannerProps) {
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        style={{ color: 'var(--io-warning, #f59e0b)', fontSize: '14px', flexShrink: 0 }}
      >
        ⚠
      </span>
      ...
      <span style={{ flex: '1 1 auto', minWidth: 0 }}>
        <strong>Popups are blocked.</strong>{' '}
        Inside/Operations uses popups for multi-window support and SSO sign-in.
        {' '}<em style={{ fontStyle: 'normal', color: 'var(--io-text-muted)' }}>{instructions}</em>
      </span>
