...
export function PublishConfirmDialog({
  ...
  const title = objectName ? `Publish ${objectName}?` : "Publish?";
    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        >
          ...
          >
            Publishing makes this object visible to all users with module
            access. A version snapshot will be created automatically.
          </Dialog.Description>
          <textarea
