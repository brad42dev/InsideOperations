...
export function DeleteConfirmDialog({
  ...
  const title = objectName ? `Delete ${objectName}?` : "Delete?";
    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        >
          ...
          >
            This object will be soft-deleted and can be recovered by an
            administrator. All version history will be preserved.
          </Dialog.Description>
          {error && (
            <p
              style={{
