...
export default function Chart03MultiAxisTrend({ config, bufferKey }: RendererProps) {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ fontSize: 11, color: 'var(--io-text-muted)', marginRight: 4 }}>View:</span>
        <button
          ...
          style={{
            ...
            background: viewMode === 'combined' ? 'var(--io-accent)' : 'var(--io-surface-elevated)',
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 4,
            border: '1px solid var(--io-border)',
            background: viewMode === 'stacked' ? 'var(--io-accent)' : 'var(--io-surface-elevated)',
