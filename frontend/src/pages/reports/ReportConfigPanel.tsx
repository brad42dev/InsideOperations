...
export default function ReportConfigPanel({
  ...
  const hierarchyQuery = useQuery({
    ...
    queryFn: async () => {
      const result = await api.get<{ areas: AreaEntry[] }>(
        "/api/v1/points/hierarchy",
      );
  ...
  const selectedAreaEntry = areas.find(
    (a) => a.name === params.area_filter || a.id === params.area_filter,
  );
  ...
  const generateMutation = useMutation({
    mutationFn: () =>
      reportsApi.generate({
        ...
        notify_email:
          params.notify_email && params.email_address ? true : undefined,
      }),
    onSuccess: (result) => {
      if (!result.success) {
        showToast({
    ...
    >
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "20px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setParams((p) => ({ ...p, start_time: e.target.value }))
                }
                style={{
                  padding: "6px 8px",
                  background: "var(--io-surface-elevated)",
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setParams((p) => ({ ...p, end_time: e.target.value }))
                }
                style={{
                  padding: "6px 8px",
                  background: "var(--io-surface-elevated)",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            ...
            {params.area_filter && (
              <select
                ...
                onChange={(e) =>
                  setParams((p) => ({ ...p, unit_filter: e.target.value }))
                }
                style={{
                  width: "100%",
                  padding: "6px 8px",
        ...
        <Section
          title="Points"
          collapsible
          defaultOpen={params.point_ids.length > 0}
        >
          <div
            style={{
              fontSize: "11px",
        ...
        <Section title="Advanced" collapsible defaultOpen={false}>
          ...
          >
            <input
              ...
              onChange={(e) =>
                setParams((p) => ({ ...p, notify_email: e.target.checked }))
              }
          ...
          {params.notify_email && (
            <input
              ...
              onChange={(e) =>
                setParams((p) => ({ ...p, email_address: e.target.value }))
              }
              style={{
                width: "100%",
