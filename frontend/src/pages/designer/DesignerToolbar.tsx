...
function IconSelect() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M3 2L3 12L6.5 9.5L8 13L9.5 12.4L8 8.8L12 8L3 2Z"
        stroke="currentColor"
        strokeWidth="1.2"
...
function IconPen() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M2 14L5 11L11 5L12 2L10 1L4 7L1 10L2 14Z"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinejoin="round"
        fill="none"
...
function IconImage() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      />
      <path
        d="M2 11L5 8L7.5 10.5L10 8.5L14 11"
        stroke="currentColor"
        strokeWidth="1.1"
        strokeLinejoin="round"
        fill="none"
...
function IconFreehand() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M2 13 C3 10 4 7 6 5 C8 3 10 4 10 6 C10 8 8 9 7 11 C6 13 7 14.5 9 14"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
        fill="none"
...
function IconPan() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M8 2V4M8 12V14M2 8H4M12 8H14M4.3 4.3L5.7 5.7M10.3 10.3L11.7 11.7M4.3 11.7L5.7 10.3M10.3 5.7L11.7 4.3"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      />
...
function IconGrid() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M2 6H14M2 10H14M6 2V14M10 2V14"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
      />
...
const DRAW_TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    shortcut: "R",
    icon: <IconRect />,
    modes: ["graphic", "dashboard", "report"],
  },
  {
    id: "ellipse",
    label: "Ellipse",
...
export default function DesignerToolbar({
  ...
  const visibleDrawTools = DRAW_TOOLS.filter((t) =>
    t.modes.includes(designMode),
  );
  ...
  return (
    ...
    >
      ...
      <IconBtn
        onClick={() => {
          if (canGroup)
            document.dispatchEvent(new CustomEvent("io:toolbar-group"));
        }}
      ...
      <IconBtn
        onClick={() => {
          if (canUngroup)
            document.dispatchEvent(new CustomEvent("io:toolbar-ungroup"));
        }}
      ...
      {visibleDrawTools.map((tool) => (
        <IconBtn
          ...
          title={
            readOnly && tool.id !== "pan"
              ? "Read-only — designer:write required"
      ...
      {selectedIds.length >= 2 && (
        <>
          <IconBtn onClick={() => handleAlign("left")} title="Align left edges">
            <IconAlignLeft />
          </IconBtn>
          <IconBtn
          ...
          <IconBtn onClick={() => handleAlign("top")} title="Align top edges">
            <IconAlignTop />
          </IconBtn>
          <IconBtn
            onClick={() => handleAlign("center-v")}
            title="Align centers (vertical)"
          >
            <IconAlignCenterV />
          </IconBtn>
          <IconBtn
      ...
      {onPublish && (
        <button
          ...
          title={
            readOnly
              ? "designer:publish permission required"
