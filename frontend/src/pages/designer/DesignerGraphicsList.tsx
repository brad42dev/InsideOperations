          ...
          items={[
            {
              ...
              onClick: () => {
                closeMenu();
                navigate(`/designer/graphics/${menuState.data!.id}/edit`);
              },
            },
            {
              ...
              onClick: () => {
                closeMenu();
                window.open(
                  `/designer/graphics/${menuState.data!.id}/edit`,
                  "_blank",
                );
              },
            },
            ...
            },
            {
              ...
              onClick: () => {
                closeMenu();
                onDelete(menuState.data!.id, menuState.data!.name);
              },
            },
          ]}
          onClose={closeMenu}
...
export default function DesignerGraphicsList() {
  ...
  const [scopeFilter, setScopeFilter] = useState<"all" | "console" | "process">(
    "all",
  );
  const [modeFilter, setModeFilter] = useState<
    "all" | "graphic" | "dashboard" | "report"
  >("all");
