...
const SYMBOL_CATEGORIES: SymbolCategory[] = [
  {
    id: "vessels",
    label: "Vessels",
    description: "Tanks, drums, and storage vessels",
    count: 6,
  },
  {
    id: "pumps",
  ...
  },
  {
    id: "valves",
    label: "Valves",
    description: "Gate, globe, ball, butterfly, and control valves",
    count: 8,
  },
  {
    id: "heat-exchangers",
  ...
  },
  {
    id: "columns",
    label: "Columns",
    description: "Distillation and absorption columns",
    count: 2,
  },
  {
    id: "compressors",
  ...
  },
  {
    id: "instruments",
    label: "Instruments",
    description: "Transmitters, indicators, and controllers",
    count: 12,
  },
  {
    id: "piping",
    label: "Piping",
    description: "Pipes, fittings, and flow direction indicators",
    count: 8,
  },
];
...
function CustomShapeRow({
  ...
  async function handleDelete() {
    if (!confirm(`Delete custom shape "${shape.name}"? This cannot be undone.`))
      return;
    setDeleting(true);
    try {
...
function CustomShapesSection() {
  ...
  async function loadShapes() {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to load custom shapes",
      );
    } finally {
      setLoading(false);
    }
    ...
    <div>
      ...
      {!loading && !error && shapes.length === 0 && (
        ...
        >
          ...
          >
            Upload an SVG file to add it to your custom shape library. Custom
            shapes appear in the Designer canvas palette alongside built-in
            ISA-101 shapes.
          </div>
        </div>
      )}
    ...
    >
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          >
            Browse ISA-101 compliant DCS equipment shapes and manage your custom
            shapes.
          </p>
        </div>
