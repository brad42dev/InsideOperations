      ...
      <div style={cardStyle}>
        <div>
          ...
          <p style={{ margin: '6px 0 0', fontSize: '14px', color: 'var(--io-text-secondary)' }}>
            Create a multi-source correlation investigation to analyse process events.
          </p>
        </div>

        <label style={{ display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '12px', fontWeight: 600, color: 'var(--io-text-secondary)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
          Investigation Name *
          <input
            value={name}
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
          <button
            ...
            style={{ padding: '9px 18px', background: 'none', border: '1px solid var(--io-border)', borderRadius: '6px', cursor: 'pointer', fontSize: '14px', color: 'var(--io-text-secondary)' }}
          >
            Cancel
          </button>
          <button
            ...
            style={{ padding: '9px 18px', background: name.trim() ? 'var(--io-accent)' : 'var(--io-surface-secondary)', border: 'none', borderRadius: '6px', cursor: name.trim() ? 'pointer' : 'not-allowed', fontSize: '14px', fontWeight: 600, color: name.trim() ? '#fff' : 'var(--io-text-muted)' }}
          >
