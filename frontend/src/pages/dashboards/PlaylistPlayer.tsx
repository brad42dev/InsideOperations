...
export default function PlaylistPlayer() {
  ...
  return (
    <div
      style={{ position: 'fixed', inset: 0, background: 'var(--io-surface-primary)', overflow: 'hidden' }}
      ...
      {showStrip && (
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            {/* Prev */}
            <button
              onClick={() => setCurrentIndex((idx) => (idx - 1 + totalItems) % totalItems)}
              style={{
                background: 'none',
                border: 'none',
                color: '#fff',
          ...
          {sortedItems.map((_, idx) => (
            <button
              ...
              style={{
                ...
                height: '8px',
                borderRadius: '100px',
                background: idx === currentIndex ? 'var(--io-accent)' : 'rgba(255,255,255,0.3)',
                border: 'none',
                cursor: 'pointer',
                padding: 0,
