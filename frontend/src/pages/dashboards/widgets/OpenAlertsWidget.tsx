  ...
  if (count === 0) {
    return (
      ...
      >
        ...
        <div style={{ fontSize: '10px', color: 'var(--io-alarm-normal)' }}>No active alerts</div>
      </div>
    )
  }
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      >
        ...
        <span style={{ fontSize: '11px', color: 'var(--io-text-muted)' }}>open alerts</span>
      </div>

      {/* Alert list */}
      <div style={{ flex: 1, overflowY: 'auto' }}>
        {alerts.map((alert) => {
          const sevColor = SEVERITY_COLORS[alert.severity] ?? 'var(--io-text-muted)'
          return (
            <div
              key={alert.id}
              style={{
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  <span style={{ textTransform: 'uppercase', color: sevColor, fontWeight: 700 }}>
                    {alert.severity}
                  </span>
