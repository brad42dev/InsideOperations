    ...
    try {
      ...
      if (res.status === 202) {
        ...
        try {
          ...
          setError(
            "Export job queued but could not read job ID from server response.",
          );
          setLoading(false);
          return;
        }
        ...
        if (jobId) {
          ...
          setError(
            "Export job queued. Check the export queue for your download.",
          );
        }
        setLoading(false);
        return;
      ...
      >
        ...
        >
          ...
          {asyncJobId && (
            ...
            >
              Export job queued (ID: {asyncJobId}). Your download will appear in
              the export queue when ready.
            </div>
          )}
        </div>
