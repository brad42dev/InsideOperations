...
export default function StalePointsWidget({ config }: Props) {
  ...
  if (count === 0) {
    return (
      ...
      >
        <div style={{ fontSize: '40px', fontWeight: 700, color: 'var(--io-alarm-normal)' }}>0</div>
        <div
          style={{
            fontSize: '11px',
      ...
      >
        <span
          style={{
            fontSize: '32px',
            fontWeight: 700,
            color: count > 10 ? 'var(--io-alarm-high)' : 'var(--io-alarm-medium)',
...
function StalePointsFallback({ thresholdMinutes }: { thresholdMinutes: number }) {
  return (
    <div
      style={{
        height: '100%',
