    ...
    async (format: ExportFormat) => {
      ...
      try {
        ...
        if (result.type === "download") {
          ...
          setExportError(
            `Export queued (job ${result.job.job_id}). You will be notified when it is ready.`,
          );
        }
      } catch (err) {
      ...
      >
        <button
          ...
          style={{
            ...
            background: "transparent",
            color:
              page === 1 ? "var(--io-text-muted)" : "var(--io-text-primary)",
        ...
        <span style={{ color: "var(--io-text-secondary)", fontSize: 13 }}>
          Page {page}
        </span>
        <button
