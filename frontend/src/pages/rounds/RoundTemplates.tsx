          ...
          {templates.map((t) => (
            ...
            >
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      color: t.is_active ? "#22c55e" : "var(--io-text-muted)",
                      fontWeight: 600,
                    }}
                  >
                ...
                >
                  {t.checkpoints.length} checkpoint
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                <PrintDialog
                  ...
                  trigger={<button style={btnStyle()}>Print</button>}
                />
                <button
                  style={btnStyle()}
                  onClick={() => navigate(`/rounds/templates/${t.id}/edit`)}
                >
                  Edit
                </button>
              </div>
