    ...
    >
      <div
        style={{
          fontSize: "13px",
          fontWeight: 700,
          color: active ? "var(--io-text-on-accent)" : "var(--io-text-primary)",
        }}
      >
        {label}
      </div>
      {desc && (
        <div
          style={{
            fontSize: "11px",
            color: active ? "rgba(255,255,255,0.75)" : "var(--io-text-muted)",
            marginTop: "2px",
          }}
        >
          {desc}
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <div style={sectionStyle}>
        ...
        <div style={optionRowStyle}>
          ...
          <OptionBtn
            label="Light"
            desc="High visibility light mode"
            active={theme === "light"}
            onClick={() => applyTheme("light")}
          />
          <OptionBtn
            label="HP-HMI"
            desc="High-contrast industrial"
            active={theme === "hphmi"}
            onClick={() => applyTheme("hphmi")}
          />
        </div>
      </div>
      ...
      <div style={sectionStyle}>
        ...
        <div style={optionRowStyle}>
          <OptionBtn
            label="Comfortable"
            desc="Standard spacing — best for desktop"
            active={density === "comfortable"}
            onClick={() => applyDensity("comfortable")}
          />
          <OptionBtn
            label="Compact"
            desc="Reduced spacing — more data on screen"
      ...
      <div style={sectionStyle}>
        ...
        <div style={optionRowStyle}>
          <OptionBtn
            ...
            active={dateFormat === "local"}
            onClick={() => applyDateFormat("local")}
          />
          <OptionBtn
            label="ISO 8601"
            desc="2026-03-18"
            active={dateFormat === "iso"}
            onClick={() => applyDateFormat("iso")}
          />
          <OptionBtn
            label="US"
            desc="03/18/2026"
            active={dateFormat === "us"}
            onClick={() => applyDateFormat("us")}
          />
        </div>
      </div>
      ...
      <div style={sectionStyle}>
        ...
        <div style={optionRowStyle}>
          <OptionBtn
            ...
            onClick={() => applyTimeFormat("24h")}
          />
          <OptionBtn
            label="12-hour"
            desc="2:30:00 PM"
            active={timeFormat === "12h"}
            onClick={() => applyTimeFormat("12h")}
          />
        </div>
      </div>
    </div>
