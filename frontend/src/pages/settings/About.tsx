      ...
      {expandedRow &&
        (() => {
          const entry = data.find(
            (d) => `${d.name}@${d.version}` === expandedRow,
          );
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {entries.length}{" "}
                  {entries.length === 1 ? "package" : "packages"}
                </span>
              </div>
                    ...
                    >
                      ...
                      >
                        ...
                        {entry.text && (
                          <button
                            onClick={() =>
                              setExpandedText(textOpen ? null : key)
                            }
                            style={{
                              background: "transparent",
                              border: "none",
  ...
  return (
    <div style={{ maxWidth: "820px" }}>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    fontWeight: 500,
                    fontFamily:
                      row.label === "Build" ? "var(--io-font-mono)" : undefined,
                  }}
                >
                  {row.value}
                </div>
      ...
      >
        ...
        organization&rsquo;s rights is provided at installation time and is
        accessible to administrators under{" "}
