...
function FlowStep({
  ...
  return (
    <div style={{ display: "flex", gap: 16 }}>
      ...
      {/* Content */}
      <div
        style={{ paddingBottom: last ? 0 : "var(--io-space-4)", paddingTop: 4 }}
      >
        <div
          style={{
            fontSize: "14px",
  ...
  return (
    <div style={{ padding: "var(--io-space-6)", maxWidth: 820 }}>
      ...
      <div style={{ marginBottom: "var(--io-space-6)" }}>
        ...
        >
          Physical badge reader configuration for site access tracking, shift
          assignment, and muster verification. Configuration is performed
          server-side by your system administrator.
        </p>
      </div>
      ...
      >
        ...
        <div>
          ...
          >
            Badge reader hardware is registered and configured in the Access
            Control service configuration file. The Phase 15 update will expose
            reader management, zone definitions, and badge event rules through
            this UI. Contact your system administrator to add or reconfigure
      ...
      <div
        style={{
          ...CARD,
          marginBottom: "var(--io-space-6)",
          padding: "var(--io-space-5) var(--io-space-5) var(--io-space-4)",
        }}
      >
        <FlowStep
          step={1}
      ...
      >
        {[
          {
            zone: "Entry / Exit",
            desc: "Main site perimeter gates. Tracks site presence.",
          },
          {
            zone: "Control Room",
            desc: "Restricted area for licensed operators only.",
          },
          {
            zone: "Process Units",
            desc: "Individual process area readers for hazardous zones.",
          },
          {
            zone: "Maintenance Workshop",
            desc: "Tool and permit issuance tracking.",
          },
          {
            zone: "Muster Points",
            desc: "Emergency assembly locations with readers.",
          },
        ].map(({ zone, desc }) => (
          <div
            key={zone}
      ...
      >
        ...
        — Badge readers, zone definitions, and credential mappings are currently
        managed in{" "}
        <code style={{ fontFamily: "monospace", fontSize: "12px" }}>
          access-control.toml
        </code>{" "}
        on the server. Contact your system administrator to register new
        readers, add employees to the badge directory, or adjust zone access
        rules. Badge event history is available in the <strong>Shifts</strong>{" "}
        module under Badge Events.
      </div>
    </div>
  );
}
