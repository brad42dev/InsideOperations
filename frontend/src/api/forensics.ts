...
export type InvestigationLinkType =
  | "log_entry"
  | "alarm_event"
  | "investigation"
  | "ticket";
...
export const forensicsApi = {
  listInvestigations: (params?: {
    ...
    api.get<Investigation[]>(
      `/api/forensics/investigations${queryString(params)}`,
    ),
  ...
  addPoints: (id: string, pointIds: string[]): Promise<ApiResult<void>> =>
    api.post<void>(`/api/forensics/investigations/${id}/points`, {
      point_ids: pointIds,
    }),
  ...
  removePoint: (
    ...
    api.post<void>(
      `/api/forensics/investigations/${id}/points/${pointId}/remove`,
      {
        reason,
      },
    ),
  ...
  addLink: (
    ...
    api.post<InvestigationLink>(
      `/api/forensics/investigations/${id}/links`,
      data,
    ),
  ...
  exportInvestigation: (
    ...
    api.post<{ url: string }>(`/api/forensics/investigations/${id}/export`, {
      format,
    }),
