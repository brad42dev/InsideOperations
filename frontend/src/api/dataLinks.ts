...
export const dataLinksApi = {
  ...
  create: (body: Omit<DataLink, 'id' | 'valid' | 'validation_reason'>): Promise<ApiResult<DataLink>> =>
    api.post<DataLink>('/api/v1/data-links', body),

  update: (id: string, body: Partial<Omit<DataLink, 'id'>>): Promise<ApiResult<DataLink>> =>
