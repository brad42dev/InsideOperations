...
export const reportsApi = {
  ...
  listTemplates: (params?: {
    ...
    api.get<PaginatedResult<ReportTemplate>>(
      `/api/reports/templates${queryString(params)}`,
    ),
  ...
  ): Promise<ApiResult<ReportTemplate>> =>
  ...
  listHistory: (params?: {
    ...
    api.get<PaginatedResult<ReportJob>>(
      `/api/reports/history${queryString(params)}`,
    ),
  ...
  listMyExports: (params?: {
    ...
    api.get<PaginatedResult<ReportJob>>(
      `/api/reports/exports${queryString(params)}`,
    ),
  ...
  listSchedules: (params?: {
    ...
    api.get<PaginatedResult<ReportSchedule>>(
      `/api/reports/schedules${queryString(params)}`,
    ),
