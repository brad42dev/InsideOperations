...
export const shiftsApi = {
  ...
  addCrewMember(
    crewId: string,
    payload: AddCrewMemberPayload,
  ): Promise<ApiResult<ShiftCrewMember>> {
  ...
  clearPresence(
    badgeId: string,
  ): Promise<ApiResult<{ cleared: boolean; badge_id: string }>> {
  ...
  createMusterPoint(
    payload: CreateMusterPointPayload,
  ): Promise<ApiResult<MusterPoint>> {
  ...
  ): Promise<ApiResult<MusterAccounting>> {
  ...
  createBadgeSource(
    payload: CreateBadgeSourcePayload,
  ): Promise<ApiResult<BadgeSource>> {
    return api.post("/api/badge-sources", payload);
  },
  updateBadgeSource(
    id: string,
    payload: UpdateBadgeSourcePayload,
  ): Promise<ApiResult<BadgeSource>> {
