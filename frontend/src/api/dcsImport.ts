...
export const PLATFORMS: PlatformInfo[] = [
  {
    ...
    support: "full",
    description:
      "ZIP containing one or more SVG files with optional data-tag attributes",
  },
  {
    id: "generic_json",
    name: "Generic JSON",
  ...
  },
  {
    ...
    support: "kit",
    description:
      "ASCII .g display files — direct file copy, no special tools needed",
  },
  {
    id: "ge_proficy",
...
export async function uploadDcsImport(
  ...
  return {
    ...
    error: {
      code: "MISSING_DATA",
      message: "No data returned from DCS import",
    },
  };
}
