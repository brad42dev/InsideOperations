...
export type NotificationSeverity = 'emergency' | 'critical' | 'warning' | 'info'
export type NotificationChannel = 'websocket' | 'email' | 'sms' | 'pa' | 'radio' | 'push'
...
export const notificationsApi = {
  // Messages
  listMessages(params?: ListMessagesParams): Promise<ApiResult<NotificationMessage[]>> {
    return api.get(`/api/notifications/messages${queryString(params as Record<string, unknown>)}`)
  },

  sendNotification(payload: SendNotificationPayload): Promise<ApiResult<NotificationMessage>> {
  ...
  // Templates
  listTemplates(params?: { enabled?: boolean }): Promise<ApiResult<NotificationTemplate[]>> {
    return api.get(`/api/notifications/templates${queryString(params as Record<string, unknown>)}`)
  },

  createTemplate(payload: CreateTemplatePayload): Promise<ApiResult<NotificationTemplate>> {
  ...
  updateTemplate(id: string, payload: UpdateTemplatePayload): Promise<ApiResult<NotificationTemplate>> {
  ...
  createGroup(payload: CreateGroupPayload): Promise<ApiResult<NotificationGroup>> {
  ...
  updateGroup(id: string, payload: UpdateGroupPayload): Promise<ApiResult<NotificationGroup>> {
  ...
  addGroupMember(groupId: string, userId: string): Promise<ApiResult<void>> {
    return api.post(`/api/notifications/groups/${groupId}/members`, { user_id: userId })
  },
  ...
  markMuster(messageId: string, payload: MarkMusterPayload): Promise<ApiResult<MusterMark>> {
