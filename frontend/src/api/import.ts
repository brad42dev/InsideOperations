...
export const importApi = {
  ...
  listTemplates(params?: {
    domain?: string;
  }): Promise<ApiResult<ConnectorTemplate[]>> {
    return api.get<ConnectorTemplate[]>(
      `${BASE}/connector-templates${queryString(params)}`,
    );
  },

  getTemplate(slug: string): Promise<ApiResult<ConnectorTemplate>> {
    return api.get<ConnectorTemplate>(
      `${BASE}/connector-templates/${encodeURIComponent(slug)}`,
    );
  },
  ...
  listConnections(params?: {
    enabled?: boolean;
  }): Promise<ApiResult<ImportConnection[]>> {
    return api.get<ImportConnection[]>(
      `${BASE}/connections${queryString(params)}`,
    );
  },
  ...
  listDefinitions(params?: {
    ...
    return api.get<ImportDefinition[]>(
      `${BASE}/definitions${queryString(params)}`,
    );
  },
  ...
  ): Promise<ApiResult<ImportSchedule>> {
    return api.post<ImportSchedule>(
      `${BASE}/definitions/${definitionId}/schedules`,
      body,
    );
  },
  ...
  listRuns(
    ...
    return api.get<ImportRun[]>(
      `${BASE}/definitions/${definitionId}/runs${queryString(params)}`,
    );
  },
  ...
  triggerRun(
    ...
    return api.post<ImportRun>(
      `${BASE}/definitions/${definitionId}/runs`,
      body,
    );
  },
