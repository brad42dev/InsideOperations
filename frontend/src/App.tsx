...
import {
  ...
  ioDarkTheme,
  ioHighContrastTheme,
} from "./shared/theme/echarts-themes";
...
const ProcessDetachedView = lazy(
  () => import("./pages/process/ProcessDetachedView"),
);

// Designer module
const DesignerPage = lazy(() => import("./pages/designer/index"));
const DesignerHome = lazy(() => import("./pages/designer/DesignerHome"));
const DesignerGraphicsList = lazy(
  () => import("./pages/designer/DesignerGraphicsList"),
);
const DesignerReportsList = lazy(
  () => import("./pages/designer/DesignerReportsList"),
);
const DesignerImport = lazy(() => import("./pages/designer/DesignerImport"));
const DesignerDashboardsList = lazy(
  () => import("./pages/designer/DesignerDashboardsList"),
);
...
const InvestigationWorkspace = lazy(
  () => import("./pages/forensics/InvestigationWorkspace"),
);
const ForensicsNew = lazy(() => import("./pages/forensics/ForensicsNew"));
const InvestigationEditor = lazy(
  () => import("./pages/forensics/InvestigationEditor"),
);
...
const LogTemplates = lazy(
  () => import(/* @vite-prefetch */ "./pages/log/LogTemplates"),
);
...
const ShiftScheduleEditor = lazy(
  () => import("./pages/shifts/ShiftScheduleEditor"),
);
const CrewList = lazy(() => import("./pages/shifts/CrewList"));
const PresenceBoard = lazy(() => import("./pages/shifts/PresenceBoard"));
const MusterPointConfig = lazy(
  () => import("./pages/shifts/MusterPointConfig"),
);
      ...
      <Routes>
        ...
        >
          ...
          <Route
            ...
            element={
              isMobile ? (
                <MobileNotAvailable module="Designer" />
              ) : (
          ...
          <Route
            ...
            element={
              isMobile ? (
                <MobileNotAvailable module="Forensics" />
              ) : (
          ...
          >
            ...
            <Route
              path="certificates"
              element={
                <PermissionGuard permission="system:certificates">
                  <CertificatesPage />
                </PermissionGuard>
              }
            />
            ...
            <Route
              path="expressions"
              element={
                <PermissionGuard permission="system:expression_manage">
                  <ExpressionLibrary />
                </PermissionGuard>
              }
            />
            ...
            <Route
              path="export-presets"
              element={
                <PermissionGuard permission="settings:export">
                  <ExportPresets />
                </PermissionGuard>
              }
            />
